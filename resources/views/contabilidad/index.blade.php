...
<div class="c-subheader justify-content-between px-3">
    ...
    <ol class="breadcrumb border-0 m-0 px-0 px-md-3">
        ...
        <li class="breadcrumb-item active"><a>Caja</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row" >
                                    ...
                                    <div class="col-lg-3">
                                        <a class="btn btn-danger btn-lg btn-block centrar" href="{{route('gastos.contabilidad')}}">
                                            <img src="{{asset('img/gasto.png')}}" style="width: 2.1rem !important;">
                                            &nbsp;<span style="margin-left: 5px;">Gastos</span></a>
                                    </div>
                                    <div class="col-lg-3">
